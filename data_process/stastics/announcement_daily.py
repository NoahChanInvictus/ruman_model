...
def test(stock,time1,date,name):
    ...
    order = 'insert into ' + 'announce' + '( stock_id,stock_name,date,time,MA_announcement,Investment_announcement, Pledge_announcement,Reducing_announcement,Profit_annoncement,' \
